...
public class Tutorial : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        StartCoroutine(GameObject.FindWithTag("AudioManager").GetComponent<AudioManager>().FadeIn("BassyMain", 2, 1, 1)); // Fade in music
    }
    ...
    void Update()
    {
        ...
        } else if (popUpIndex == 6)
        {
            ...
            if (Input.GetKeyDown(KeyCode.Space))
                ...
                StartCoroutine(GameObject.FindWithTag("AudioManager").GetComponent<AudioManager>().FadeOut("BassyMain", 2, 0, 1)); // Fade out music
        }
    }
}
